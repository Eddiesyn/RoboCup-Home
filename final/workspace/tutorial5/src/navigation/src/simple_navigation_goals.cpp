...
bool Navigation::turn(perception_msgs::send_flags::Request &req, perception_msgs::send_flags::Response &res){
...
//bool Navigation::set_flag_end(perception_msgs::send_flags::Request &req, perception_msgs::send_flags::Response &res){

//    ROS_INFO("Now we gonna to end the demo...");
//    if(req.flag)
//    {
//        bool end= moveRelative(0.1, 0.1, 0.0);
