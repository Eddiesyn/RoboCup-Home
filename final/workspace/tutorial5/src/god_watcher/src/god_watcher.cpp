...
bool God_watcher::set_flag_catch(perception_msgs::send_flags::Request &req, perception_msgs::send_flags::Response &res)
{
    if(req.flag){
...
bool God_watcher::set_flag_put(perception_msgs::send_flags::Request &req, perception_msgs::send_flags::Response &res)
{
    if(req.flag){
...
int main(int argc, char** argv)
{
    ...
    ros::ServiceClient client_navigation_catch = n.serviceClient<perception_msgs::send_flags>("/tiago/catch");
    ros::ServiceClient client_navigation_turn = n.serviceClient<perception_msgs::send_flags>("/tiago/turn");
    ros::ServiceClient client_navigation_put = n.serviceClient<perception_msgs::send_flags>("/tiago/put");

    ros::ServiceClient client_getPoints = n.serviceClient<perception_msgs::send_flags>("/tiago/from_2d_to_3d");
    ros::ServiceClient client_sending_pose = n.serviceClient<perception_msgs::send_flags>("/tiago/send_place_msg");

    ros::ServiceClient client_pick = n.serviceClient<perception_msgs::send_flags>("/tiago/pick");
    ros::ServiceClient client_lower_torso = n.serviceClient<perception_msgs::send_flags>("/tiago/lower_torso");
    ros::ServiceClient client_place = n.serviceClient<perception_msgs::send_flags>("/tiago/place");
    ros::ServiceClient client_readygo = n.serviceClient<perception_msgs::send_flags>("/tiago/readygo");
