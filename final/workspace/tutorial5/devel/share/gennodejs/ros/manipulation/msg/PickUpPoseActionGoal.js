...
let PickUpPoseGoal = require('./PickUpPoseGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class PickUpPoseActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PickUpPoseGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PickUpPoseGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PickUpPoseActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PickUpPoseGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PickUpPoseGoal()
    }
...
module.exports = PickUpPoseActionGoal;
