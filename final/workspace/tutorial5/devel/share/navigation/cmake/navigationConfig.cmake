...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/atHomeSS18/God-Watcher/workspace/tutorial5/src/navigation)
  set(navigation_DEVEL_PREFIX /home/atHomeSS18/God-Watcher/workspace/tutorial5/devel)
  ...
  set(navigation_INSTALL_PREFIX /home/atHomeSS18/God-Watcher/workspace/tutorial5/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/atHomeSS18/God-Watcher/workspace/tutorial5/src/navigation/${idir}'.  ${_report}")
    endif()
