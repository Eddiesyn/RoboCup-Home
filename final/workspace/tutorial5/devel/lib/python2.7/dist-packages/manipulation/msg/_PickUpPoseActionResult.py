...
"""autogenerated by genpy from manipulation/PickUpPoseActionResult.msg. Do not edit."""
import sys
...
class PickUpPoseActionResult(genpy.Message):
  ...
  _type = "manipulation/PickUpPoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','manipulation/PickUpPoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = manipulation.msg.PickUpPoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = manipulation.msg.PickUpPoseResult()
