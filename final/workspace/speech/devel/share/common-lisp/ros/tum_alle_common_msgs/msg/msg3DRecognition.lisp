...
(cl:defclass <msg3DRecognition> (roslisp-msg-protocol:ros-message)
  ((image
    :reader image
    :initarg :image
   ...
   (predictions3D
    :reader predictions3D
    :initarg :predictions3D
...
(cl:defclass msg3DRecognition (<msg3DRecognition>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <msg3DRecognition>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'msg3DRecognition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tum_alle_common_msgs-msg:<msg3DRecognition> is deprecated: use tum_alle_common_msgs-msg:msg3DRecognition instead.")))

(cl:ensure-generic-function 'image-val :lambda-list '(m))
(cl:defmethod image-val ((m <msg3DRecognition>))
...
(cl:defmethod depth_image-val ((m <msg3DRecognition>))
...
(cl:defmethod transform-val ((m <msg3DRecognition>))
...
(cl:defmethod predictions2D-val ((m <msg3DRecognition>))
...
(cl:ensure-generic-function 'predictions3D-val :lambda-list '(m))
(cl:defmethod predictions3D-val ((m <msg3DRecognition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_alle_common_msgs-msg:predictions3D-val is deprecated.  Use tum_alle_common_msgs-msg:predictions3D instead.")
  (predictions3D m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <msg3DRecognition>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'predictions3D))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'predictions3D))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <msg3DRecognition>) istream)
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <msg3DRecognition>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'predictions3D) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <msg3DRecognition>))
  "Converts a ROS message object to a list"
  (cl:list 'msg3DRecognition
    (cl:cons ':image (image msg))
    (cl:cons ':depth_image (depth_image msg))
    (cl:cons ':transform (transform msg))
    (cl:cons ':predictions2D (predictions2D msg))
    (cl:cons ':predictions3D (predictions3D msg))
))
