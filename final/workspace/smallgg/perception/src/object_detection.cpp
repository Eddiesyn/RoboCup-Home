...
public:
    ...
    pub_pt = nh_.advertise<geometry_msgs::PointStamped>("/God_watcher/ObjPoint3D", 10);
...
bool getOrder(all_msgs::send_flags::Request &req, all_msgs::send_flags::Response &res)
{
  if(req.flag)
  {
    flag = req.flag;
