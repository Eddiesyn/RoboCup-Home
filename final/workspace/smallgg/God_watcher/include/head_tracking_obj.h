#ifndef HEAD_TRACKING_OBJ
#define HEAD_TRACKING_OBJ
...
public:
	Head_tracking_Obj(ros::NodeHandle nh) : nh_(nh), priv_nh_("~")
	{
		...
		sub_people = nh_.subscribe("/God_watcher/ObjPoint3D",1, &Head_tracking::HeadCallback, this);
...
void Head_tracking_Obj::CameraInfo(const sensor_msgs::CameraInfoConstPtr& _info)
{
	fx = _info->K.at(0);
	fy = _info->K.at(4);
	cx = _info->K.at(2);
...
void Head_tracking_Obj::HeadCallback(const geometry_msgs::PointStampedConstPtr& _pt)
{
...
void Head_tracking_Obj::createPointHeadClient(PointHeadClientPtr& actionClient)
{
