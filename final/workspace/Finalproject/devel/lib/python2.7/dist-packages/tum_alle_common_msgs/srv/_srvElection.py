...
"""autogenerated by genpy from tum_alle_common_msgs/srvElectionRequest.msg. Do not edit."""
import sys
...
class srvElectionRequest(genpy.Message):
  _md5sum = "3a7b3fc5693370dcb683822fe58db2ce"
  _type = "tum_alle_common_msgs/srvElectionRequest"
...
"""
  __slots__ = ['tracked_id','image','ids','predictions']
  _slot_types = ['int32','sensor_msgs/Image','int32[]','tum_alle_common_msgs/msg2DPrediction[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       tracked_id,image,ids,predictions
    ...
    """
    if args or kwds:
      super(srvElectionRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_i3I().pack(_x.tracked_id, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.tracked_id, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from tum_alle_common_msgs/srvElectionResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class srvElectionResponse(genpy.Message):
  _md5sum = "cfa26713f7564a36d6c15c911217d3b9"
  _type = "tum_alle_common_msgs/srvElectionResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(srvElectionResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
def _get_struct_I():
    global _struct_I
    return _struct_I
class srvElection(object):
  _type          = 'tum_alle_common_msgs/srvElection'
  _md5sum = '346d402876d63bbe29aa8a26ef5fda79'
  _request_class  = srvElectionRequest
  _response_class = srvElectionResponse
