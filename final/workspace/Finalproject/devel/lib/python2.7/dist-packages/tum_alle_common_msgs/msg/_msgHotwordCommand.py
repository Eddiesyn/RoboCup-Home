...
"""autogenerated by genpy from tum_alle_common_msgs/msgHotwordCommand.msg. Do not edit."""
import sys
...
class msgHotwordCommand(genpy.Message):
  _md5sum = "cba5e21e920a3a2b7b375cb65b64cdea"
  _type = "tum_alle_common_msgs/msgHotwordCommand"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Contains the last hotword command recognised
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(msgHotwordCommand, self).__init__(*args, **kwds)
