...
"""autogenerated by genpy from tum_alle_common_msgs/msg3DRecognition.msg. Do not edit."""
import sys
...
class msg3DRecognition(genpy.Message):
  _md5sum = "2fc33243fc44bdd87226013491c4ef2a"
  _type = "tum_alle_common_msgs/msg3DRecognition"
...
float64 z
"""
  __slots__ = ['image','depth_image','transform','predictions2D','predictions3D']
  _slot_types = ['sensor_msgs/Image','sensor_msgs/Image','geometry_msgs/Transform','tum_alle_common_msgs/msg2DPrediction[]','tum_alle_common_msgs/msg3DPrediction[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       image,depth_image,transform,predictions2D,predictions3D
    ...
    """
    if args or kwds:
      super(msg3DRecognition, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.predictions3D)
      buff.write(_struct_I.pack(length))
      for val1 in self.predictions3D:
        _x = val1.frame
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.predictions3D.append(val1)
      return self
