...
if("TRUE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /home/atHomeSS18/God-Watcher/workspace/Finalproject/src/perception)
  set(perception_DEVEL_PREFIX /home/atHomeSS18/God-Watcher/workspace/Finalproject/devel)
  ...
  set(perception_INSTALL_PREFIX /home/atHomeSS18/God-Watcher/workspace/Finalproject/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/atHomeSS18/God-Watcher/workspace/Finalproject/src/perception/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;std_msgs;sensor_msgs;all_msgs;geometry_msgs;control_msgs")
