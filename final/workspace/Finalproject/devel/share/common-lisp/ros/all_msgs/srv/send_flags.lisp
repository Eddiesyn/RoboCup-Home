...
(cl:defmethod cl:initialize-instance :after ((m <send_flags-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'send_flags-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name all_msgs-srv:<send_flags-request> is deprecated: use all_msgs-srv:send_flags-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <send_flags-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'send_flags-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name all_msgs-srv:<send_flags-response> is deprecated: use all_msgs-srv:send_flags-response instead.")))
